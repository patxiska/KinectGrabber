...
public:
	...
	void GetRotation(FLOAT rotationXYZ[3]) {rotationXYZ[0] = m_RPitch; rotationXYZ[1] = m_RYaw; rotationXYZ[2] = m_RRoll;}
	void GetTranslation(FLOAT translationXYZ[3]) {translationXYZ[0] = m_RTranslationX; translationXYZ[1] = m_RTranslationY; translationXYZ[2] = m_RTranslationZ;}
...
private:
	...
	float m_RTranslationX;
    float m_RTranslationY;
	float m_RTranslationZ;
