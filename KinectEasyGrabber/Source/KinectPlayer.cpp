...
HRESULT KinectPlayer::Init(NUI_IMAGE_TYPE depthType, NUI_IMAGE_RESOLUTION depthRes, BOOL bNearMode, BOOL bFallbackToDefault, NUI_IMAGE_TYPE colorType, NUI_IMAGE_RESOLUTION colorRes, BOOL bSeatedSkeletonMode)
{
...
DWORD WINAPI KinectPlayer::ProcessThread(LPVOID pParam)
{
    KinectPlayer*  pthis=(KinectPlayer *) pParam;
    HANDLE          hEvents[4];
...
void KinectPlayer::GotVideoAlert( )
{
...
void KinectPlayer::GotDepthAlert( )
{
    const NUI_IMAGE_FRAME* pImageFrame = NULL;
...
void KinectPlayer::GotSkeletonAlert()
{
...
HRESULT KinectPlayer::GetClosestHint(FT_VECTOR3D* pHint3D)
{
